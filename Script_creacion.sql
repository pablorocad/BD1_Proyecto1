...
CREATE TABLE compra_venta (
    cod_compra_venta       INTEGER GENERATED BY DEFAULT ON NULL AS IDENTITY,
...
ALTER TABLE compra_venta ADD CONSTRAINT compra_venta_pk PRIMARY KEY ( cod_compra_venta );
...
ALTER TABLE compra_venta
    ADD CONSTRAINT compra_venta_compania_fk FOREIGN KEY ( compania_cod_compania )
        REFERENCES compania ( cod_compania );

ALTER TABLE compra_venta
    ADD CONSTRAINT compra_venta_persona_fk FOREIGN KEY ( persona_id_persona )
        REFERENCES persona ( id_persona );

ALTER TABLE compra_venta
    ADD CONSTRAINT compra_venta_producto_fk FOREIGN KEY ( producto_cod_producto )
        REFERENCES producto ( cod_producto );

ALTER TABLE persona
    ADD CONSTRAINT persona_region_fk FOREIGN KEY ( region_cod_region )
...
ALTER TABLE region
    ADD CONSTRAINT region_ciudad_fk FOREIGN KEY ( ciudad_cod_ciudad )
